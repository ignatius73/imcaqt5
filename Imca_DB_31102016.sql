...
-- Dumping data for table imca.alumnos: ~18 rows (approximately)
...
-- Dumping data for table imca.calificaciones: ~10 rows (approximately)
...
-- Dumping data for table imca.registros: ~25 rows (approximately)

...
-- Volcando datos para la tabla imca.alumnos: ~16 rows (aproximadamente)
...
-- Volcando datos para la tabla imca.asignaturas: ~60 rows (aproximadamente)
...
REPLACE INTO `asignaturas` (`id_asignatura`, `nombre`, `carrera`, `correlativas`, `horario`, `vacantes`, `anio`, `cursada_paralela`, `duracion`, `valor`) VALUES
	...
	(56, 'CURSO 1', '4', NULL, NULL, NULL, 99, NULL, 4, 100),
	(57, 'CURSO II', '4', NULL, NULL, NULL, 99, NULL, 4, 25),
	(58, 'CURSO III', '4', NULL, NULL, NULL, 99, NULL, 4, 400),
	(59, 'CURSO IV', '4', NULL, NULL, NULL, 99, NULL, 4, 150),
	(60, 'CURSO V', '4', NULL, NULL, NULL, 99, NULL, 4, 150);
...
-- Volcando datos para la tabla imca.caja: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla imca.calificaciones: ~7 rows (aproximadamente)
...
-- Volcando datos para la tabla imca.cuentas: ~20 rows (aproximadamente)
/*!40000 ALTER TABLE `cuentas` DISABLE KEYS */;
REPLACE INTO `cuentas` (`id`, `periodo`, `asignatura`, `importe`, `detalle`, `dni`, `estado`) VALUES
	(1, 'Octubre 2016', 56, 100, 'CURSO 1', 23235867, '0'),
	(2, 'Octubre 2016', 57, 25, 'CURSO II', 23235867, '0'),
	(3, 'Octubre 2016', 58, 400, 'CURSO III', 23235867, '0'),
	(4, 'Octubre 2016', 59, 150, 'CURSO IV', 23235867, '0'),
	(5, 'Octubre 2016', 60, 150, 'CURSO V', 23235867, '0'),
	(6, 'Octubre 2016', 56, 100, 'CURSO 1', 23235867, '0'),
	(7, 'Octubre 2016', 57, 25, 'CURSO II', 23235867, '0'),
	(8, 'Octubre 2016', 58, 400, 'CURSO III', 23235867, '0'),
	(9, 'Octubre 2016', 59, 150, 'CURSO IV', 23235867, '0'),
	(10, 'Octubre 2016', 60, 150, 'CURSO V', 23235867, '0'),
	(11, 'Octubre 2016', 56, 100, 'CURSO 1', 23235867, '0'),
	(12, 'Octubre 2016', 57, 25, 'CURSO II', 23235867, '0'),
	(13, 'Octubre 2016', 58, 400, 'CURSO III', 23235867, '0'),
	(14, 'Octubre 2016', 59, 150, 'CURSO IV', 23235867, '0'),
	(15, 'Octubre 2016', 60, 150, 'CURSO V', 23235867, '0'),
	(16, 'Octubre 2016', 56, 100, 'CURSO 1', 23235867, '0'),
	(17, 'Octubre 2016', 57, 25, 'CURSO II', 23235867, '0'),
	(18, 'Octubre 2016', 58, 400, 'CURSO III', 23235867, '0'),
	(19, 'Octubre 2016', 59, 150, 'CURSO IV', 23235867, '0'),
	(20, 'Octubre 2016', 60, 150, 'CURSO V', 23235867, '0');
...
-- Volcando datos para la tabla imca.registros: ~15 rows (aproximadamente)
...
-- Volcando datos para la tabla imca.valores: ~2 rows (aproximadamente)

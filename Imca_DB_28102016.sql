...
-- Dumping data for table imca.alumnos: ~14 rows (approximately)
...
-- Dumping data for table imca.asignaturas: ~60 rows (approximately)
...
-- Dumping data for table imca.calificaciones: ~2 rows (approximately)
...
REPLACE INTO `calificaciones` (`id_calif`, `id_asign`, `cuatri1`, `cuatri2`, `recup`, `final1`, `final2`, `final3`, `final4`, `nota`, `fecha_final`, `alumno`, `fecha_inscripcion`) VALUES
	(1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 23235867, '2016-10-25'),
	(2, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 23235867, '2016-10-25');
...
-- Dumping data for table imca.cuentas: ~0 rows (approximately)
...
-- Dumping data for table imca.registros: ~0 rows (approximately)
/*!40000 ALTER TABLE `registros` DISABLE KEYS */;
REPLACE INTO `registros` (`id`, `fecha`, `hora`, `user`) VALUES
	(1, '2016-10-28', '12:54:19', 'root'),
	(2, '2016-10-28', '13:03:10', 'root');
